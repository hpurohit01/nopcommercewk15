package com.demo.nopcommerce.uitility;

import com.demo.nopcommerce.drivermanager.ManageDriver;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/test/java/resources/screenshot" + screenshotName + dateName + ".png";
        File finalDestination = new File(destination);//src/test/java/resources/screenshot
        try {
